...
export function getConfig(runtime: IAgentRuntime) {
  const akash_env = runtime.getSetting("AKASH_ENV");
  switch (akash_env) {
    case "mainnet":
      return {
        ...
        AKASH_WALLET_ADDRESS: runtime.getSetting("AKASH_WALLET_ADDRESS") || "",
        AKASH_PRICING_API_URL: runtime.getSetting("AKASH_PRICING_API_URL") || "https://console-api.akash.network/v1/pricing",
        AKASH_DEFAULT_CPU: runtime.getSetting("AKASH_DEFAULT_CPU") || "1000",
        AKASH_DEFAULT_MEMORY: runtime.getSetting("AKASH_DEFAULT_MEMORY") || "1000000000",
        AKASH_DEFAULT_STORAGE: runtime.getSetting("AKASH_DEFAULT_STORAGE") || "1000000000",
        AKASH_SDL: runtime.getSetting("AKASH_SDL") || "example.sdl.yml",
        AKASH_CLOSE_DEP: runtime.getSetting("AKASH_CLOSE_DEP") || "closeAll",
        AKASH_CLOSE_DSEQ: runtime.getSetting("AKASH_CLOSE_DSEQ") || "",
        AKASH_PROVIDER_INFO: runtime.getSetting("AKASH_PROVIDER_INFO") || "",
        AKASH_DEP_STATUS: runtime.getSetting("AKASH_DEP_STATUS") || "param_passed",
        AKASH_DEP_DSEQ: runtime.getSetting("AKASH_DEP_DSEQ") || "",
        AKASH_GAS_OPERATION: runtime.getSetting("AKASH_GAS_OPERATION") || "close",
        AKASH_GAS_DSEQ: runtime.getSetting("AKASH_GAS_DSEQ") || "",
        AKASH_MANIFEST_MODE: runtime.getSetting("AKASH_MANIFEST_MODE") || "auto",
        AKASH_MANIFEST_PATH: runtime.getSetting("AKASH_MANIFEST_PATH") || "",
        AKASH_MANIFEST_VALIDATION_LEVEL: runtime.getSetting("AKASH_MANIFEST_VALIDATION_LEVEL") || "strict",
        AKASH_DEPOSIT: runtime.getSetting("AKASH_DEPOSIT") || "500000uakt",
      };
    case "testnet":
      return {
...
export async function validateAkashConfig(
    ...
    try {
        ...
        const akashNet = runtime.getSetting("AKASH_NET") || envConfig.AKASH_NET;
        ...
        const config = {
            ...
            AKASH_NODE: node,
            RPC_ENDPOINT: runtime.getSetting("RPC_ENDPOINT") || envConfig.RPC_ENDPOINT,
            AKASH_GAS_PRICES: runtime.getSetting("AKASH_GAS_PRICES") || envConfig.AKASH_GAS_PRICES,
            AKASH_GAS_ADJUSTMENT: runtime.getSetting("AKASH_GAS_ADJUSTMENT") || envConfig.AKASH_GAS_ADJUSTMENT,
            AKASH_KEYRING_BACKEND: runtime.getSetting("AKASH_KEYRING_BACKEND") || envConfig.AKASH_KEYRING_BACKEND,
            AKASH_FROM: runtime.getSetting("AKASH_FROM") || envConfig.AKASH_FROM,
            AKASH_FEES: runtime.getSetting("AKASH_FEES") || envConfig.AKASH_FEES,
            AKASH_PRICING_API_URL: runtime.getSetting("AKASH_PRICING_API_URL") || envConfig.AKASH_PRICING_API_URL,
            AKASH_DEFAULT_CPU: runtime.getSetting("AKASH_DEFAULT_CPU") || envConfig.AKASH_DEFAULT_CPU,
            AKASH_DEFAULT_MEMORY: runtime.getSetting("AKASH_DEFAULT_MEMORY") || envConfig.AKASH_DEFAULT_MEMORY,
            AKASH_DEFAULT_STORAGE: runtime.getSetting("AKASH_DEFAULT_STORAGE") || envConfig.AKASH_DEFAULT_STORAGE,
            AKASH_SDL: runtime.getSetting("AKASH_SDL") || envConfig.AKASH_SDL,
            AKASH_CLOSE_DEP: runtime.getSetting("AKASH_CLOSE_DEP") || envConfig.AKASH_CLOSE_DEP,
            AKASH_CLOSE_DSEQ: runtime.getSetting("AKASH_CLOSE_DSEQ") || envConfig.AKASH_CLOSE_DSEQ,
            AKASH_PROVIDER_INFO: runtime.getSetting("AKASH_PROVIDER_INFO") || envConfig.AKASH_PROVIDER_INFO,
            AKASH_DEP_STATUS: runtime.getSetting("AKASH_DEP_STATUS") || envConfig.AKASH_DEP_STATUS,
            AKASH_DEP_DSEQ: runtime.getSetting("AKASH_DEP_DSEQ") || envConfig.AKASH_DEP_DSEQ,
            AKASH_GAS_OPERATION: runtime.getSetting("AKASH_GAS_OPERATION") || envConfig.AKASH_GAS_OPERATION,
            AKASH_GAS_DSEQ: runtime.getSetting("AKASH_GAS_DSEQ") || envConfig.AKASH_GAS_DSEQ,
            AKASH_MANIFEST_MODE: runtime.getSetting("AKASH_MANIFEST_MODE") || envConfig.AKASH_MANIFEST_MODE,
            AKASH_MANIFEST_PATH: runtime.getSetting("AKASH_MANIFEST_PATH") || envConfig.AKASH_MANIFEST_PATH,
            AKASH_MANIFEST_VALIDATION_LEVEL: runtime.getSetting("AKASH_MANIFEST_VALIDATION_LEVEL") || envConfig.AKASH_MANIFEST_VALIDATION_LEVEL,
            AKASH_DEPOSIT: runtime.getSetting("AKASH_DEPOSIT") || envConfig.AKASH_DEPOSIT
        };
